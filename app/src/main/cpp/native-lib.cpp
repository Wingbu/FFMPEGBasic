...
Java_com_example_wingbu_ffmpegbasic_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_wingbu_ffmpegbasic_MainActivity_stringFromJHello(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_wingbu_ffmpegbasic_MainActivity_decode(JNIEnv *env, jclass type, jstring input_,
                                                     jstring output_) {
    //获取输入输出文件名
    ...
    FFLOGI("视频时长：%lld", (pFormatCtx->duration)/1000000);
...
Java_com_example_wingbu_ffmpegbasic_MainActivity_play(JNIEnv *env, jclass type, jstring input_,
                                                     jobject surface) {
    ...
    const char *file_name = env->GetStringUTFChars(input_, 0);
